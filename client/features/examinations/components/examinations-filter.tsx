...
import { ExamType, ExamStatus } from "../types/examination.types";

interface ExaminationsFilterProps {
  search: string;
...
export default function ExaminationsFilter({
  search,
  onSearchChange,
  status,
  onStatusChange,
  ...
  onSemesterChange,
  onReset,
}: ExaminationsFilterProps) {
  // Fetch dependencies lists
  ...
  const examTypes = ["MIDTERM", "FINAL", "PRACTICAL", "VIVA", "QUIZ", "ASSIGNMENT"];
